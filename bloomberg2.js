      ...
      <div class="screener-sidebar">
        <div class="screener-filters" id="screener-filters-panel">
          ...
          <div class="screener-filters-body" id="screener-filters-body">
            ...
            <button class="screener-run-btn" id="screener-run-btn" onclick="(function(){ var v = document.getElementById('view-screener'); if(v && window.collectScreenerFilters) window.collectScreenerFilters(v); if(window.runScreen) window.runScreen(window.screenerFilters||{}); })()">
...
function registerBloomberg2Globals() {
  ...
  window.collectScreenerFilters = collectScreenerFilters;
  window.screenerFilters = screenerFilters;
}
